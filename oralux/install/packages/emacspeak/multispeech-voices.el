;;; This file has been modified for Oralux
;;; * Using multispeech with other TTS.
;;; 18 Dec 2005, Gilles Casse <gcasse@oralux.org>
;;;
...
;; GC 2005/12/08: condition added
  (if (string-match "ru" (getenv "LANGUAGE"))
