...
# ----------------------------------------------------------------------------
# menu.sh
# $Id: menu.sh,v 1.9 2006/01/22 15:19:45 gcasse Exp $
# $Author: gcasse $
...
Copy2Oralux()
{
   ...
   chroot $BUILD bash -c "cd /usr/bin; ln -s /usr/share/oralux/dialog/dialog.php dialog-oralux;install -m 755 /usr/share/oralux/dialog/oralux-dialog.sh /usr/bin"
