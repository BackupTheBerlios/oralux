/* options.c: slightly updated for Multispeech-up 
March 2006, Gilles Casse <gcasse@oralux.org> */
/*
 ...
 *
 * $Id: options.c,v 1.1 2006/04/17 09:11:43 gcasse Exp $
 */
...
options_print_help(char *argv[])
{
    ...
    printf("multispeech-up -- Interface between Multispeech and SpeakUp (GNU GPL)\n\n");
    ...
    "multispeech-up is based on speechd-up-0.1:\n"
...
{
    printf("%s %s\n", PACKAGE, VERSION);
    printf("multispeech-up is based on speechd-up-0.1:\n"
	   "Copyright (C) 2003,2005 Brailcom, o.p.s.\n"
	   "This is free software; you can redistribute it and/or modify it\n"
...
options_set_default(void)
{
  ...
  LOG_LEVEL = 3;
  LOG_FILE_NAME = (char*) strdup("/var/log/multispeech-up.log");
