// ----------------------------------------------------------------------------
// braille.c
// $Id: braille.c,v 1.2 2005/01/30 21:43:51 gcasse Exp $
// $Author: gcasse $
	...
	while(aMenuState != MENU_End)
	  {
		...
		aMenuState = (GNC_UpArrowKey == getLastKeyPressed()) ? MENU_Braille : MENU_Port;
		break;
		
	      case MENU_Port:
		serialPortChoose( & theInfo->myPort);
		aMenuState = (GNC_UpArrowKey == getLastKeyPressed()) ? MENU_Table : MENU_Confirm;
		break;
